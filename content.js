...
window.WEDDING = {
  ...
  hostsAwaiting: {
    ...
    names: [
      ...
      { en: "Mrs. Anshuya Mehul Dayaram Jabuani", gu: "શ્રીમતી અનસૂયા મેહુલ દયારામ જાબુઆની" },
  ...
  gallery: {
    ...
    photos: [
      { src: "assets/photos/gallery-01-cafe-window.jpg",  alt: { en: "Jeet and Bhavini laughing together by a cafe window", gu: "કૅફેની બારી પાસે હસતાં જીત અને ભાવિની" } },
      { src: "assets/photos/gallery-02-cafe-arch.jpg",    alt: { en: "Jeet kissing Bhavini's hand under a green arch", gu: "લીલી કમાન નીચે ભાવિનીનો હાથ ચૂમતો જીત" } },
      { src: "assets/photos/gallery-03-beach-hands.jpg",  alt: { en: "Jeet and Bhavini reaching for each other's hands in the waves", gu: "મોજાંમાં એકબીજાનો હાથ પકડતાં જીત અને ભાવિની" } },
      { src: "assets/photos/gallery-04-beach-back.jpg",   alt: { en: "Jeet and Bhavini standing back to back on the shore", gu: "દરિયાકિનારે પીઠથી પીઠ મિલાવીને ઊભેલાં જીત અને ભાવિની" } },
      { src: "assets/photos/gallery-05-cliff-cove.jpg",   alt: { en: "Jeet and Bhavini walking a quiet cove below a limestone cliff", gu: "ખડક નીચેના શાંત કિનારે ચાલતાં જીત અને ભાવિની" } },
      { src: "assets/photos/gallery-06-beach-rocks.jpg",  alt: { en: "Bhavini with her arm around Jeet, looking out to sea", gu: "દરિયા તરફ નિહાળતાં ભાવિની અને જીત" } },
      { src: "assets/photos/gallery-07-boat-bw.jpg",      alt: { en: "Jeet and Bhavini holding hands beside a longtail boat, in black and white", gu: "હોડી પાસે હાથમાં હાથ લઈ ઊભેલાં જીત અને ભાવિની" } },
      { src: "assets/photos/gallery-08-boat-colour.jpg",  alt: { en: "Jeet and Bhavini by a longtail boat on a turquoise bay", gu: "ભૂરા દરિયાકિનારે હોડી પાસે જીત અને ભાવિની" } },
      { src: "assets/photos/gallery-09-vintage-car.jpg",  alt: { en: "Jeet and Bhavini beside a white vintage car on an old town street", gu: "જૂના શહેરની શેરીમાં સફેદ વિન્ટેજ કાર પાસે જીત અને ભાવિની" } },
    ],
  },
