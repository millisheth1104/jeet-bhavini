...
window.WEDDING = {
  ...
  hostsAwaiting: {
    ...
    children: {
      en: "and Miti, Khushi, Vanshika, Kashyap, Yakshit, Darsh, Trisha, Bhavyansh, Jiyansh, Kiyanshi",
      gu: "તથા મિતિ, ખુશી, વંશીકા, કશ્યપ, યક્ષીત, દર્શ, ત્રિશા, ભવ્યાંશ, જિયાંશ, કિયાંશી",
    },
  },
  ...
  /* ---------------------------------------------------------------------
     ...
     --------------------------------------------------------------------- */
  ui: {
    langName:          { en: "English", gu: "ગુજરાતી" },
